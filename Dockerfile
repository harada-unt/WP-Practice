...
ENV APACHE_RUN_GROUP=$USERNAME\
    ...
    DOCUMENT_ROOT="/var/www/app${PUBLIC_DIR}"\
...
WORKDIR /var/www/app
COPY --chown=$USERNAME:$USERNAME . /var/www/app
RUN rm -rf /var/www/html\
 && chown $USERNAME:$USERNAME -R /var/www/app\
 && /bin/bash -c 'if [ "$DOCUMENT_ROOT" != "/var/www/html" ];\
    then rm -rf /var/www/html && ln -s $DOCUMENT_ROOT /var/www/html;\
    fi'
